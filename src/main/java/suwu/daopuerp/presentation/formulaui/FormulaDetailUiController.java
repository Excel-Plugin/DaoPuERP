...
public class FormulaDetailUiController extends FormulaDetailUi implements ExternalLoadableUiController {
    @FXML
    ...
    public ExternalLoadedUiPackage showContent(FormulaDto formulaDto) {
        ...
        FormulaDetailUiController formulaDetailUiController = externalLoadedUiPackage.getController();
